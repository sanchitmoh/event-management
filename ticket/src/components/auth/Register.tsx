...
function Register({ onSuccess, onLoginClick }: RegisterProps) {
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="bg-white/90 backdrop-blur-lg w-full max-w-md rounded-2xl shadow-2xl p-8 space-y-8 relative overflow-hidden">
        ...
        <div className="text-center relative">
          ...
          <h2 className="text-4xl font-bold bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent">Create Account</h2>
          <p className="mt-2 text-gray-600">Join us and start managing your events</p>
        </div>
